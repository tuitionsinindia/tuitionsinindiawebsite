...
export function studentDay3Template(name) {
    return wrap(`
...
export function studentDay7Template(name, tutorCount) {
    return wrap(`
...
export function tutorDay3Template(name) {
    return wrap(`
...
export function tutorDay7Template(name) {
    return wrap(`
...
export function reEngagementTemplate(name, matchCount) {
    return wrap(`
...
export function conversionNudgeTemplate(name, tutorName, subject) {
    return wrap(`
