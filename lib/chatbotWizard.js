...
export const TUTOR_FLOW = [
    "category",
    "subject",
    "grade",       // what level they teach
    "city",
    "rate",        // TUTOR_RATE_CHOICES
    "experience",  // EXPERIENCE_CHOICES
    "otp",         // name + phone + OTP
    "email",       // email (after verified login)
    "confirm",
    "done",        // complete_tutor_profile, redirect to /dashboard/tutor
];
...
export const INSTITUTE_FLOW = [
    ...
    "subject",
    "city",
    "otp",         // contact person name + phone + OTP
    "email",
    "confirm",
    "done",        // create institute listing, redirect to /dashboard/institute
];
...
export const STAGE_PROMPTS = {
    ...
    TUTOR: {
        ...
        grade:    "What levels do you teach?",
        ...
        otp:      "Let's verify your phone to create your tutor account.",
        email:    "Last thing — your email address (for lead alerts).",
        confirm:  "Looks good? I'll create your tutor profile.",
        done:     "Your tutor profile is live! Taking you to your dashboard…",
    },
    INSTITUTE: {
        ...
        otp:      "Verify the contact person's phone to activate your listing.",
        email:    "Your official email address?",
        confirm:  "Here's your listing. Publish?",
        done:     "Institute listing created. Taking you to the dashboard…",
    },
};
