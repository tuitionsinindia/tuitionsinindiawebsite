...
// Cities live now — tutors available for search
export const ACTIVE_CITIES = ["Mumbai", "Navi Mumbai", "Thane"];

// Cities launching soon — shown grayed out in dropdowns
export const COMING_SOON_CITIES = ["Delhi", "Bangalore", "Pune", "Hyderabad", "Chennai", "Kolkata", "Noida", "Gurgaon"];

// Full list kept for backward compat with search API string matching
