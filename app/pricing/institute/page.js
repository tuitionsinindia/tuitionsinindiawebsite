...
export default function InstitutePricing() {
    return (
        <div className="min-h-screen bg-white text-gray-900 antialiased">
            ...
            <section className="py-16 px-6 text-center border-b border-gray-100">
                <div className="max-w-2xl mx-auto">
                    ...
                    <p className="text-lg text-gray-500">
                        List your coaching centre, academy, or school. Reach students across India.
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-6 items-stretch">
                    ...
                    <div className="bg-white border border-gray-200 rounded-2xl p-8 flex flex-col">
                        ...
                        <ul className="space-y-4 mb-8 flex-1">
                            {[
                                "Basic institute listing",
                                "Receive student enquiries",
                                "List up to 3 courses",
                                "1 branch location",
            ...
            <section className="py-16 px-6 bg-gray-50">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="text-sm text-gray-400 mt-6">Credits can be purchased from your institute dashboard after signing up.</p>
                </div>
            </section>
            ...
            <section className="py-16 px-6 border-t border-gray-100 text-center">
                <div className="max-w-xl mx-auto">
                    ...
                    <p className="text-gray-500 mb-8">
                        Our team is happy to help you choose the right plan for your institute.
                    </p>
                    <Link
                        href="/contact"
