        ...
        <div className="min-h-screen bg-background-dark font-sans text-on-background-dark antialiased pt-40 pb-32 selection:bg-primary/30">
            ...
            <section className="py-24 px-6 relative overflow-hidden text-center max-w-7xl mx-auto mb-24">
                ...
                <div className="inline-flex items-center gap-3 px-4 py-2 bg-primary/10 rounded-full border border-primary/20 mb-10">
                    ...
                    <span className="text-primary text-[10px] font-black uppercase tracking-[0.3em]">Investment in Potential</span>
                </div>
            ...
            <section className="px-6 max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
                ...
                <div className="bg-surface-dark p-12 md:p-20 rounded-[4rem] border border-border-dark shadow-4xl flex flex-col items-center text-center hover:border-primary/20 transition-all group overflow-hidden relative">
                    ...
                    <div className="mb-16">
                        <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em] mb-4">Indicative Rate</p>
                    ...
                    <Link href="/search" className="w-full py-6 bg-background-dark border border-border-dark text-white font-black rounded-2xl hover:border-primary/50 transition-all uppercase tracking-widest text-[10px] active:scale-95 shadow-xl">
                        Explore Faculty
                    </Link>
                </div>
                ...
                <div className="bg-surface-dark p-12 md:p-20 rounded-[4.5rem] border-4 border-primary shadow-4xl shadow-primary/10 flex flex-col items-center text-center relative group scale-105 z-10 transition-transform active:scale-100">
                    <div className="absolute -top-5 right-16 bg-primary text-white text-[10px] font-black uppercase tracking-[0.3em] px-10 py-3 rounded-2xl shadow-xl">
                    ...
                    <div className="mb-16">
                        <p className="text-[10px] font-black text-primary uppercase tracking-[0.3em] mb-4">Efficiency Protocol</p>
                    ...
                    <Link href="/ai-match" className="w-full py-7 bg-primary text-white font-black rounded-2xl hover:scale-105 transition-all uppercase tracking-widest text-[10px] shadow-2xl shadow-primary/40 active:scale-95">
                        Inquire Strategy
                    </Link>
                </div>
            </section>
            ...
            <section className="py-24 text-center max-w-xl mx-auto px-6">
                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-on-background-dark/20 mb-8 px-4">Need Guidance?</p>
