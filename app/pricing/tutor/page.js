        ...
        <div className="snap-container bg-white text-gray-900 antialiased selection:bg-blue-200">
            ...
            <section className="snap-section px-6 relative text-center">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="inline-flex items-center gap-3 px-4 py-2 bg-blue-50 rounded-full border border-blue-100 mb-8">
                        ...
                        <span className="text-blue-700 text-[10px] font-black uppercase tracking-[0.3em]">Economic Mandate</span>
                    </div>
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 items-stretch">
                    ...
                    <div className="bg-white border border-gray-100 p-10 rounded-[3rem] shadow-sm flex flex-col h-full hover:shadow-2xl transition-all group active:scale-95">
                        <div className="mb-10">
                            ...
                            <p className="text-gray-400 text-[10px] font-black uppercase tracking-widest italic tracking-[0.2em]">Tier One Discovery</p>
                        </div>
                        ...
                        <Link href="/register/tutor" className="w-full py-5 bg-gray-900 text-white font-black rounded-2xl hover:bg-blue-600 transition-all text-center uppercase tracking-widest text-[10px]">Initialize Profile</Link>
                    </div>
                    ...
                    <div className="bg-white p-10 rounded-[3.5rem] border-4 border-blue-600 shadow-4xl shadow-blue-600/10 flex flex-col h-full relative group scale-105 z-10 transition-transform active:scale-100">
                        <div className="absolute -top-5 right-10 bg-blue-600 text-white text-[10px] font-black uppercase tracking-[0.3em] px-6 py-3 rounded-2xl shadow-xl animate-bounce">
                            Elite Mandate
                        </div>
                        <div className="mb-10 pt-4">
                            ...
                            <p className="text-blue-600 text-[10px] font-black uppercase tracking-widest italic tracking-[0.2em]">Institutional Hub Standard</p>
                        </div>
                        <div className="flex flex-col mb-10">
                            ...
                            <p className="text-[10px] text-blue-600 font-black uppercase tracking-[0.2em] mt-4">Zero Commission Protocol Locked</p>
                        </div>
                        <ul className="space-y-6 mb-12 flex-1">
                            {[
                        ...
                        <Link href="/register/tutor" className="w-full py-6 bg-blue-600 text-white font-black rounded-2xl hover:scale-105 transition-all text-center uppercase tracking-widest text-[10px] shadow-2xl shadow-blue-600/40">Deploy Profile</Link>
                    </div>
                    ...
                    <div className="bg-white border border-gray-100 p-10 rounded-[3rem] shadow-sm flex flex-col h-full hover:shadow-2xl transition-all group active:scale-95">
                        <div className="mb-10">
                            ...
                            <p className="text-gray-400 text-[10px] font-black uppercase tracking-widest italic tracking-[0.2em]">Multifaceted Entity</p>
                        </div>
                        ...
                        <Link href="/register/tutor" className="w-full py-5 bg-gray-900 text-white font-black rounded-2xl hover:bg-blue-600 transition-all text-center uppercase tracking-widest text-[10px]">Deploy Hub</Link>
                    </div>
            ...
            <section className="snap-section px-6 text-center max-w-xl mx-auto">
                ...
                <div className="flex flex-col items-center gap-8">
                    ...
                    <div className="flex items-center justify-center gap-2 text-[10px] font-black text-gray-300 uppercase tracking-[0.5em]">
