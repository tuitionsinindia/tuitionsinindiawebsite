                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-3xl p-10 border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/20 mb-8">
                        <div className="flex items-center gap-6 mb-8 text-left">
                            ...
                            <div>
                                <h1 className="text-3xl font-heading font-bold">Institute Billing</h1>
                                <p className="text-slate-500 font-medium">Manage corporate billing, bulk credit purchases, and instructor payouts.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-8 border border-slate-200 dark:border-slate-700 text-center mb-10">
                            <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-2">Total Institute Spend</p>
...
export default function Earnings() {
    return (
        <Suspense fallback={<div className="p-10 text-center text-slate-500 font-bold animate-pulse">Loading Billing...</div>}>
            <EarningsContent />
        </Suspense>
    );
}
